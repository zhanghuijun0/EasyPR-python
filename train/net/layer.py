...
class ImageLayer(Layer):
    ...
    def __init__(self, image_height, image_width, n_channels, layer_name='IMAGE'):
        ...
        super(ImageLayer, self).__init__(layer_in=None, layer_out=image)
...
class LabelLayer(Layer):
    ...
    def __init__(self, layer_name='LABEL'):
        ...
        super(LabelLayer, self).__init__(layer_in=None, layer_out=label)
...
class ConvLayer(Layer):
    ...
    def __init__(self,
        ...
        super(ConvLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output, weights=[filters, ],
                                        biases=[biases, ])
...
class ActivationLayer(Layer):
    ...
    def __init__(self, prev_layer, activation=tf.nn.relu, layer_name='ACTIVATION'):
        ...
        super(ActivationLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output)
...
class MaxPoolLayer(Layer):
    ...
    def __init__(self, prev_layer, pool_height, pool_width, layer_name='MAXPOOL', padding='SAME'):
        ...
        super(MaxPoolLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output)
...
class FlattenLayer(Layer):
    ...
    def __init__(self, prev_layer, layer_name='FLATTEN'):
        ...
        super(FlattenLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output)
...
class DenseLayer(Layer):
    ...
    def __init__(self,
        ...
        super(DenseLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output, weights=[weights, ],
                                         biases=[biases, ])
...
class OutputLayer(Layer):
    ...
    def __init__(self,
        ...
        super(OutputLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output, weights=[weights, ],
                                          biases=[biases, ])
...
class DropoutLayer(Layer):
    def __init__(self, prev_layer, prob, layer_name='dropout'):
        ...
        super(DropoutLayer, self).__init__(layer_in=prev_layer.output, layer_out=layer_output)
...
class ConvPoolLayer(Layer):
    ...
    def __init__(self,
        ...
        with tf.variable_scope("CONVPOOL" + str(layer_id)):
            conv = ConvLayer(prev_layer,
                             filter_height, filter_width, n_filters, "CONV" + str(layer_id),
                             stride, padding, weight_init, bias_init)
            act = ActivationLayer(conv, activation, layer_name='CPACTIVATION' + str(layer_id))
            pool = MaxPoolLayer(act, pool_height, pool_width, "POOL" + str(layer_id), padding)

        self.conv = conv
        self.activation = act
        self.pool = pool
        super(ConvPoolLayer, self).__init__(layer_in=prev_layer.output, layer_out=pool.output, weights=conv.weights,
                                            biases=conv.biases)
